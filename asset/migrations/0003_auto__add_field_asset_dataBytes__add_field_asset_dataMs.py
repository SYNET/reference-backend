...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Asset.dataBytes'
        db.add_column('asset_asset', 'dataBytes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Asset.dataMs'
        db.add_column('asset_asset', 'dataMs', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Asset.dataBytes'
        db.delete_column('asset_asset', 'dataBytes')

        # Deleting field 'Asset.dataMs'
        db.delete_column('asset_asset', 'dataMs')
    ...
    models = {
        ...
        'asset.asset': {
            ...
            'dataMs': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'asset.chunk': {
