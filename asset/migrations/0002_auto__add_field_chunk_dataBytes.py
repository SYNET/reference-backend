...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Chunk.dataBytes'
        db.add_column('asset_chunk', 'dataBytes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Chunk.dataBytes'
        db.delete_column('asset_chunk', 'dataBytes')
