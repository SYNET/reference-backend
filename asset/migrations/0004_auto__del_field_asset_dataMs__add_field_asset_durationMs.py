...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Asset.durationMs'
        db.add_column('asset_asset', 'durationMs', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Asset.dataMs'
        raise RuntimeError("Cannot reverse this migration. 'Asset.dataMs' and its values cannot be restored.")

        # Deleting field 'Asset.durationMs'
        db.delete_column('asset_asset', 'durationMs')
