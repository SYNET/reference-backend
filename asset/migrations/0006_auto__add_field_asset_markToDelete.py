...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Asset.markToDelete'
        db.add_column('asset_asset', 'markToDelete', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Asset.markToDelete'
        db.delete_column('asset_asset', 'markToDelete')
