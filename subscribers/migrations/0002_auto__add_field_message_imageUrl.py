...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.imageUrl'
        db.add_column('subscribers_message', 'imageUrl', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.imageUrl'
        db.delete_column('subscribers_message', 'imageUrl')
