...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ChannelCategory', fields ['code']
        db.create_unique('channels_channelcategory', ['code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ChannelCategory', fields ['code']
        db.delete_unique('channels_channelcategory', ['code'])
