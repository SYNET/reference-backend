...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Channel.mode'
        db.delete_column('channels_channel', 'mode')


    def backwards(self, orm):
        
        # Adding field 'Channel.mode'
        db.add_column('channels_channel', 'mode', self.gf('django.db.models.fields.CharField')(default=u'DVB', max_length=5), keep_default=False)
