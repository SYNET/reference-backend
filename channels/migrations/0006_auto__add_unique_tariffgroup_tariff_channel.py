...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'TariffGroup', fields ['tariff', 'channel']
        db.create_unique('channels_tariffgroup', ['tariff_id', 'channel_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'TariffGroup', fields ['tariff', 'channel']
        db.delete_unique('channels_tariffgroup', ['tariff_id', 'channel_id'])
    ...
    models = {
        ...
        'channels.tariffgroup': {
            'Meta': {'unique_together': "(('channel', 'tariff'),)", 'object_name': 'TariffGroup'},
            'channel': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['channels.Channel']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tariff': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['channels.Tariff']"})
        },
